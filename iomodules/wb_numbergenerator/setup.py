...
setuptools.setup(
    name=PROJECT,
    version=VERSION,
    description="A WishBone IO module which generates a continuing stream of increasing numbers.",
    author="Jelle Smet",
    ...
    entry_points="""
        [wishbone.iomodule]
        NumberGenerator=wb_numbergenerator.numbergenerator:NumberGenerator
    """
)
