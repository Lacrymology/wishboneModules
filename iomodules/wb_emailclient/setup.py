...
setuptools.setup(
    name=PROJECT,
    version=VERSION,
    description="A Wishbone IO module which creates and sends an email out of incoming documents.",
    author="Jelle Smet",
    url="https://github.com/smetj/wishboneModules",
    install_requires=['wishbone','Cheetah','gevent_inotifyx'],
    packages=setuptools.find_packages(),
    include_package_data=True,
    entry_points="""
        [wishbone.iomodule]
        EmailClient=wb_emailclient.emailclient:EmailClient
    """
)
